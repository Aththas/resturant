      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="cart.php">cart <i class="ion-ios-arrow-forward"></i></a></span> <span>payment page<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    ...
                                                    <form role="form" id="payment-form" style="padding: 0.375rem 0.75rem;" method="POST">
                                                        <div class="row">
                                                            <div class="col-xs-12">
                                                                <div class="form-group">
                                                                    <label>Billing Address</label>
                                                                    <div class="input-group">
                                                                        <textarea name="address" placeholder="Address" cols="50" rows="2" class="form-control" style="width: 30rem;"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12 col-md-12">
                                                                <input class="btn btn-primary" type="submit" name="codPay" value="Make Payment">
                                                            </div>
                                                        </div>
                                                    </form>
...
if(isset($_POST["codPay"]))
{
    ...
    else
    {
        ...
        mysqli_query($link, "insert into tbl_order values('','$orderDate','$userId','$addr','$tot','Cash On Delivery', 'success' )");
        ...
        if(isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
            ...
            mysqli_query($link, "insert into order_product values('$orderId','$productId','$foodPrice','$quantity','$subtotal')");
            }
            // Clear the cart after adding the items to the order_product table
            unset($_SESSION['cart']);
        }
        ...
        swal({
                title: "Order Success",
                text: "Order has been done successfully!!!",
                icon: "success"
            }).then(function() {
...
if(isset($_POST["cardPay"]))
{
    ...
    else
    {
        ...
        mysqli_query($link, "insert into tbl_order values('','$orderDate','$userId','$addr','$tot','Online Payment', 'success' )");
        $orderId = mysqli_insert_id($link);
