      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Booked List Details</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="viewBookings.php">view bookings <i class="ion-ios-arrow-forward"></i></a></span> <span>Booking # <?php echo $resId; ?><i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                      $rsOrderDetails = mysqli_query($link, "select * from reservation_product where resId = '$resId'");
                      ...
                      <tr>
                        ...
                        <td class="border-0 align-middle"><strong>LKR <?php echo $row["total"]; ?></strong></td>
                      </tr>
                      <?php
                      }
                      ?>
