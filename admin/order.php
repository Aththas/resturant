                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $cus = $row["userId"];
                                            $res1= mysqli_query($link,"select username from user where id = '$cus' ");
                                            ...
                                            echo "<td>"; echo $row["orderStatus"]; echo "</td>";
                                            echo "<td>"; ?> 
                                                <a href="viewOrder.php?id=<?php echo $row['orderId']; ?>"> <i class="far fa-eye" style="color: green; font-size: 18px;"></i> </a>
                                            <?php echo "</td>";
                                            echo "</tr>";
                                            }
                                        ?>
