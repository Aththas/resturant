...
.form-container .cancel {
  ...
  <form method="POST" class="form-container" enctype="multipart/form-data">
    ...
    <label for="des"><b>Short Description</b></label>
    <textarea name="short_des"></textarea>

    <label for="des"><b>Long Description</b></label>
    <textarea name="long_des"></textarea>
        ...
        return true;
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = "SELECT * FROM food where status='active' order by id desc";     
...
if(isset($_POST["add_product"]))
{
    ...
    if($_POST["name"] == "" || $_POST["pcategory"] == "" || $_POST["long_des"] == "" || $_POST["short_des"] == "" || $_POST["price"] == "")
    {
        ?>
        <script type="text/javascript">
            swal({
                title: "Food Creation Failure",
    ...
    else
    {
        ...
        mysqli_query($link,"insert into food values('','$_POST[name]','$dst1','$_POST[price]','$_POST[short_des]','$_POST[long_des]','$_POST[pcategory]','active')");

        ?>
        <script type="text/javascript">
            swal({
                title: "Food Creation Success",
                text: "New Food has been Added Successfully!!!",
                icon: "success"
            }).then(function() {
